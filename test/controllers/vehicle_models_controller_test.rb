...
class VehicleModelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehicle_model" do
    assert_difference('VehicleModel.count') do
      post vehicle_models_url, params: { vehicle_model: { name: @vehicle_model.name, note: @vehicle_model.note, vehicle_make_id: @vehicle_model.vehicle_make_id } }
    end
  ...
  test "should update vehicle_model" do
    patch vehicle_model_url(@vehicle_model), params: { vehicle_model: { name: @vehicle_model.name, note: @vehicle_model.note, vehicle_make_id: @vehicle_model.vehicle_make_id } }
